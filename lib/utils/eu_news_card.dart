...
class EUNewsCard extends StatelessWidget {
  final EUProjectModel project;
  final List<EUMetaData?>? news;

  const EUNewsCard({Key? key, required this.news, required this.project}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    String featuredImage = getEUMetaDataValue(news, 'featured_image') ?? project.featuredImage;
